...
import {
  addExplanationsMutation,
  deleteExplanationsMutation,
  fetchExplanationsQuery,
...
const ManageOurExplanationsScreen = () => {
  const { data, isLoading, refetch } = fetchExplanationsQuery();
  const [mainImage, pickMainImage, isLoadingMainImage] = useImagePicker();
  const { mutate: addExplanations, isLoading: isAdding } =
    addExplanationsMutation();
...
export default ManageOurExplanationsScreen;
